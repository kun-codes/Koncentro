...
class TargetClickTeachingTip(TeachingTip):
    ...
    def __init__(
        ...
        # this removes the invisible border around TargetClickTeachingTip which obstructs input to buttons and other
        # clickable things.
        # TODO: Note that this still has a slight border around the edge contained the arrow (tip) which points
        # towards elements but it is very small and doesn't obstruct anything. It is only visible on flatpak wayland
